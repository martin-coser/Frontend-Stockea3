...
const API_URL = process.env.REACT_APP_API_URL 
  ? `${process.env.REACT_APP_API_URL}/marca`
...
const Marca: React.FC = () => {
  ...
  const confirmarEliminarMarca = async () => {
    ...
    try {
      ...
      setIdMarcaAEliminar(null); // Limpia el ID
    }
  };
    ...
    <motion.div className="flex min-h-screen bg-gray-600" layout>
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <h3 className="font-bold text-gray-200 mt-2">Listado de Marcas</h3>
          ...
          >
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full">
              ...
              <p className="text-center text-gray-700 mb-6">
                ¿Estás seguro que querés eliminar esta marca?
              </p>
          ...
          >
            ...
            {filtrarMarcasEliminadas(marcasEliminadas).length === 0 ? (
              <p className="text-center text-gray-600">
                No hay marcas eliminadas que coincidan con los filtros.
              </p>
            ) : (
              <table className="w-full border-collapse mt-8">
                ...
                <tbody>
                  {filtrarMarcasEliminadas(marcasEliminadas).map(
                    (marca: any) => (
